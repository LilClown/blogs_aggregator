...
--changeset Ilay:create-identity-schema
--comment create new identity schema
create schema identity;
--rollback drop schema identity;

--changeset Ilay:create-identity-user_accounts-table
...
--changeset Ilay:create-identity-user_roles-table
...
--changeset Ilay:create-identity-user_accounts_roles-table
...
--changeset Ilay:add-user_accounts_roles-table-constraints
...
--changeset Ilay:add-data-to-user_roles-table
